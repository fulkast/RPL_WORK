...
feature -- Access
	...
	set_connectivity(str : STRING)		-- Set the connectivity using one of the below functions
		do
	...
	set_four_connect()		-- Set to using four connectivity
		do
			connect_four := true
		end

	set_eight_connect()		-- Set to using eight connectivity
		do
			connect_eight := true
		end

	get_connectivity_strategy()	: GRID_CONNECTIVITY_STRATEGY	-- retrieve the set connectivity strategy
		do
