...
feature {ROS_MESSAGE}
	...
	deallocate_c_msg (a_msg_ptr: POINTER)
		external
			"C++ inline use %"geometry_msgs/Vector3.h%""
		alias
			"delete (geometry_msgs::Vector3*)$a_msg_ptr;"
		end
...
feature {NONE} -- Externals
	...
	get_x_from_c (c_ptr: POINTER): REAL_64
		external
			"C++ inline use %"geometry_msgs/Vector3.h%""
		alias
			"return (double)(((geometry_msgs::Vector3*)($c_ptr))->x);"
		end
	...
	get_y_from_c (c_ptr: POINTER): REAL_64
		external
			"C++ inline use %"geometry_msgs/Vector3.h%""
		alias
			"return (double)(((geometry_msgs::Vector3*)($c_ptr))->y);"
		end
	...
	get_z_from_c (c_ptr: POINTER): REAL_64
		external
			"C++ inline use %"geometry_msgs/Vector3.h%""
		alias
			"return (double)(((geometry_msgs::Vector3*)($c_ptr))->z);"
		end
	...
	c_ros_advertize (a_worker_obj: POINTER; a_queue_size: INTEGER; a_is_latched: BOOLEAN)
		external
			"C++ inline  use %"publisher.h%", %"geometry_msgs/Vector3.h%""
		alias
			"((Publisher*)($a_worker_obj))->advertize <geometry_msgs::Vector3> ($a_queue_size, $a_is_latched);"
		end
	...
	c_ros_publish (a_worker_obj: POINTER; a_msg_ptr: POINTER)
		external
			"C++ inline use %"publisher.h%", %"geometry_msgs/Vector3.h%""
		alias
			"((Publisher*)($a_worker_obj))->publish_message <geometry_msgs::Vector3> (*((geometry_msgs::Vector3*)$a_msg_ptr));"
		end

	subscribe_to_ros (a_worker_obj: POINTER; c_topic_name: POINTER; obj: ANY; routine: POINTER)
		external
			"C++ inline use %"subscriber.h%", %"geometry_msgs/Vector3.h%""
		alias
			"((Subscriber*)($a_worker_obj))->subscribe<geometry_msgs::Vector3, geometry_msgs::Vector3::ConstPtr> ($c_topic_name, $obj, $routine);"
		end
end
