...
extern void F422_3461(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F422_3462(EIF_REFERENCE);
extern EIF_TYPED_VALUE F422_3463(EIF_REFERENCE);
extern EIF_TYPED_VALUE F422_3464(EIF_REFERENCE);
extern void F422_7586(EIF_REFERENCE, int);
...
void F422_3461 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 421, Current, 0, 3, 3473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(421, Current, 3473);
	RTCC(arg1, 421, l_feature_name, 1, RTWCT(2784, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 2784, 0xF80001A6, 0); /* active */
	RTAR(Current, arg1);
...
EIF_TYPED_VALUE F422_3462 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F422_3463 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F422_3464 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F422_7586 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 421, Current, 0, 7585);
	RTSA(dtype);
	RTME(dtype, 0);
