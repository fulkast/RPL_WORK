...
extern EIF_TYPED_VALUE F427_2615(EIF_REFERENCE);
extern EIF_TYPED_VALUE F427_2616(EIF_REFERENCE);
extern void F427_2617(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F427_7570(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F427_2615 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 426, Current, 0, 0, 2616);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(426, Current, 2616);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F427_2616 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 426, Current, 0, 0, 2617);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(426, Current, 2617);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2140, Dtype(Current)))(Current)).it_b);
...
/* {DISPENSER}.append */
void F427_2617 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 426, Current, 0, 1, 2618);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(426, Current, 2618);
	{
		...
		RTCC(arg1, 426, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
void F427_7570 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 426, Current, 0, 7569);
	RTSA(dtype);
	RTME(dtype, 0);
