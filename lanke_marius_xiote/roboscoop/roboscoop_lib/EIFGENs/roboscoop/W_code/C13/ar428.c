...
extern void F428_5353(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F428_5354(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F428_5355(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F428_5356(EIF_REFERENCE);
extern EIF_TYPED_VALUE F428_5357(EIF_REFERENCE);
...
void F428_5353 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 427, Current, 0, 1, 8931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(427, Current, 8931);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ui4_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3921, dtype))(Current, ui4_1x);
	RTHOOK(3);
...
/* {ARRAYED_STACK}.put */
void F428_5354 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 427, Current, 0, 1, 8932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(427, Current, 8932);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {ARRAYED_STACK}.force */
void F428_5355 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 427, Current, 0, 1, 8933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(427, Current, 8933);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
void F428_5356 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 427, Current, 0, 0, 8934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(427, Current, 8934);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F428_5357 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 427, Current, 1, 0, 8935);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(427, Current, 8935);
	RTIV(Current, RTAL);
	RTHOOK(1);
