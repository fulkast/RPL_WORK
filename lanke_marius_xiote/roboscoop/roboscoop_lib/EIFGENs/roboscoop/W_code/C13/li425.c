...
extern EIF_TYPED_VALUE F425_3555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F425_3556(EIF_REFERENCE);
extern void F425_3557(EIF_REFERENCE);
extern void F425_3558(EIF_REFERENCE);
extern EIF_TYPED_VALUE F425_3559(EIF_REFERENCE);
extern EIF_TYPED_VALUE F425_3560(EIF_REFERENCE);
...
EIF_TYPED_VALUE F425_3555 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 424, Current, 1, 0, 3945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 3945);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2131, 347))(Current)).it_i4);
	} else {
		RTHOOK(4);
...
EIF_TYPED_VALUE F425_3556 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 424, Current, 0, 0, 3946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 3946);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(2852, dtype));
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2132, 347))(Current)).it_b);
	} else {
		RTHOOK(3);
		RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
		tb1 = '\01';
...
void F425_3557 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 424, Current, 0, 0, 3947);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 3947);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2858, 347))(Current);
	RTHOOK(2);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(2852, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 2861, 0xF80001A6, 0); /* active */
...
void F425_3558 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 424, Current, 2, 0, 3948);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 3948);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
body:;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2133, 347))(Current);
	RTHOOK(3);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(2852, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F425_3559 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F425_3560 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
