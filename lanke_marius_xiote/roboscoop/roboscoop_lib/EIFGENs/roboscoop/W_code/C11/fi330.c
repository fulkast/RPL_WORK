...
extern EIF_TYPED_VALUE F330_2614(EIF_REFERENCE);
extern void F330_7569(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F330_2614 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 329, Current, 0, 0, 2586);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(329, Current, 2586);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F330_7569 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 329, Current, 0, 7568);
	RTSA(dtype);
	RTME(dtype, 0);
