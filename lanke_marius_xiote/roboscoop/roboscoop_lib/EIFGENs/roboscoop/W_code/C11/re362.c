...
extern EIF_TYPED_VALUE F362_2631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F362_2632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F362_2633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F362_2634(EIF_REFERENCE);
extern void F362_2635(EIF_REFERENCE);
extern void F362_7573(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F362_2631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F362_2632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F362_2633 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 361, Current, 0, 0, 2673);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(361, Current, 2673);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F362_2634 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 361, Current, 0, 0, 2674);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(361, Current, 2674);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F362_2635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 361, Current, 0, 0, 2669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(361, Current, 2669);
	RTIV(Current, RTAL);
...
void F362_7573 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 361, Current, 0, 7572);
	RTSA(dtype);
	RTME(dtype, 0);
