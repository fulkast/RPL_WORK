...
extern EIF_TYPED_VALUE F334_2785(EIF_REFERENCE);
extern void F334_2788(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F334_7579(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F334_2785 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 333, Current, 0, 0, 3024);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(333, Current, 3024);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F334_2788 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 333, Current, 0, 1, 3025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(333, Current, 3025);
	RTCC(arg1, 333, l_feature_name, 1, RTWCT(2219, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2288, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2290, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F334_7579 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 333, Current, 0, 7578);
	RTSA(dtype);
	RTME(dtype, 0);
