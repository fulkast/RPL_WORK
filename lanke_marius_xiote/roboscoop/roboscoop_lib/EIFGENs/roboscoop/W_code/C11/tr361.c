...
extern void F361_2670(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F361_2671(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F361_2672(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F361_2673(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F361_7574(EIF_REFERENCE, int);
...
/* {TRAVERSABLE}.do_all */
void F361_2670 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 360, Current, 0, 1, 2758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(360, Current, 2758);
	{
		...
		RTCC(arg1, 360, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
/* {TRAVERSABLE}.do_if */
void F361_2671 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 360, Current, 0, 2, 2759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(360, Current, 2759);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,305,0xFF01,0,0xFF01,0xFFF9,1,241,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
	...
	}
	{
		...
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg2, 360, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F361_2672 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 360, Current, 0, 1, 2760);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(360, Current, 2760);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,319,0xFF01,0,0xFF01,0xFFF9,1,241,0,0,255,0xFFFF};
		EIF_TYPE typres0;
		{
...
/* {TRAVERSABLE}.for_all */
EIF_TYPED_VALUE F361_2673 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 360, Current, 0, 1, 2761);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(360, Current, 2761);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,319,0xFF01,0,0xFF01,0xFFF9,1,241,0,0,255,0xFFFF};
		EIF_TYPE typres0;
		{
...
void F361_7574 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 360, Current, 0, 7573);
	RTSA(dtype);
	RTME(dtype, 0);
