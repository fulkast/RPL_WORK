...
extern EIF_TYPED_VALUE F845_2540(EIF_REFERENCE);
extern EIF_TYPED_VALUE F845_2541(EIF_REFERENCE);
extern EIF_TYPED_VALUE F845_2542(EIF_REFERENCE);
extern void F845_2543(EIF_REFERENCE);
extern void F845_2544(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F845_2540 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 844, Current, 0, 0, 2486);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(844, Current, 2486);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F845_2541 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F845_2542 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 844, Current, 0, 0, 2483);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(844, Current, 2483);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F845_2543 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 844, Current, 0, 0, 2484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(844, Current, 2484);
	RTIV(Current, RTAL);
...
void F845_2544 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 844, Current, 0, 0, 2485);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(844, Current, 2485);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
