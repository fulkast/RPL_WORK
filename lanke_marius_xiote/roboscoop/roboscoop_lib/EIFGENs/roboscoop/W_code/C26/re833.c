...
extern EIF_TYPED_VALUE F833_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F833_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 832, Current, 0, 0, 3977);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(832, Current, 3977);
	RTIV(Current, RTAL);
	RTHOOK(1);
