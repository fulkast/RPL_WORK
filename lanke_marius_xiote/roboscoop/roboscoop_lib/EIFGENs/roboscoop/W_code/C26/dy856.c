...
extern EIF_TYPED_VALUE F856_3737(EIF_REFERENCE);
extern EIF_TYPED_VALUE F856_3738(EIF_REFERENCE);
extern void F856_3744(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F856_3747(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F856_3748(EIF_REFERENCE);
extern EIF_TYPED_VALUE F856_3749(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F856_3737 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 855, Current, 0, 0, 5215);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(855, Current, 5215);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F856_3738 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 855, Current, 0, 0, 5216);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(855, Current, 5216);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F856_3744 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 855, Current, 0, 1, 5217);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(855, Current, 5217);
	RTIV(Current, RTAL);
...
void F856_3747 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 855, Current, 0, 1, 5218);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(855, Current, 5218);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F856_3748 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 855, Current, 0, 0, 5219);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(855, Current, 5219);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F856_3749 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 855, Current, 2, 1, 5220);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(855, Current, 5220);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ui8_1 = ti8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2152, "extend", Result))(Result, ui8_1x);
		RTHOOK(9);
