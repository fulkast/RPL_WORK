...
extern EIF_TYPED_VALUE F370_3737(EIF_REFERENCE);
extern EIF_TYPED_VALUE F370_3738(EIF_REFERENCE);
extern void F370_3744(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F370_3747(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F370_3748(EIF_REFERENCE);
extern EIF_TYPED_VALUE F370_3749(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F370_3737 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 369, Current, 0, 0, 5143);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(369, Current, 5143);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F370_3738 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 369, Current, 0, 0, 5144);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(369, Current, 5144);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F370_3744 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 369, Current, 0, 1, 5145);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(369, Current, 5145);
	RTIV(Current, RTAL);
...
void F370_3747 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 369, Current, 0, 1, 5146);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(369, Current, 5146);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F370_3748 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 369, Current, 0, 0, 5147);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(369, Current, 5147);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F370_3749 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 369, Current, 2, 1, 5148);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(369, Current, 5148);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
