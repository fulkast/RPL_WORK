...
extern EIF_TYPED_VALUE F392_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F392_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 391, Current, 0, 0, 3965);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(391, Current, 3965);
	RTIV(Current, RTAL);
	RTHOOK(1);
