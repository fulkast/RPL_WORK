...
extern EIF_TYPED_VALUE F367_2824(EIF_REFERENCE);
extern EIF_TYPED_VALUE F367_2825(EIF_REFERENCE);
extern void F367_2826(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F367_2827(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F367_2828(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F367_2829(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F367_2830(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SEQUENCE}.readable */
EIF_TYPED_VALUE F367_2824 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 366, Current, 0, 0, 3075);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(366, Current, 3075);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SEQUENCE}.writable */
EIF_TYPED_VALUE F367_2825 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 366, Current, 0, 0, 3076);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(366, Current, 3076);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2220, Dtype(Current)))(Current)).it_b);
...
/* {SEQUENCE}.force */
void F367_2826 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 366, Current, 0, 1, 3077);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 3077);
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F367_2827 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 366, Current, 1, 1, 3078);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 3078);
	{
		...
		RTCC(arg1, 366, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.put */
void F367_2828 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 366, Current, 0, 1, 3079);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 3079);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {SEQUENCE}.prune */
void F367_2829 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 366, Current, 0, 1, 3080);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 3080);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune_all */
void F367_2830 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 366, Current, 0, 1, 3081);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 3081);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
