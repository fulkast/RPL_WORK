...
extern EIF_TYPED_VALUE F759_3752(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F759_3753(EIF_REFERENCE);
extern EIF_TYPED_VALUE F759_3754(EIF_REFERENCE);
extern void F759_7594(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F759_3752 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 758, Current, 2, 1, 5267);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 5267);
	RTCC(arg1, 758, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu2_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2188, "item", arg1))(arg1)).it_n2);
...
/* {LIST}.after */
EIF_TYPED_VALUE F759_3753 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 758, Current, 0, 0, 5268);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 5268);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F759_3754 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 758, Current, 0, 0, 5269);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(758, Current, 5269);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F759_7594 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 758, Current, 0, 7593);
	RTSA(dtype);
	RTME(dtype, 0);
