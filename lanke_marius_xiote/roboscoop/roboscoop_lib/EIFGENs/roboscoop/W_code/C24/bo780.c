...
extern EIF_TYPED_VALUE F780_2628(EIF_REFERENCE);
extern void F780_7571(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F780_2628 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 779, Current, 0, 0, 2656);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(779, Current, 2656);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F780_7571 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 779, Current, 0, 7570);
	RTSA(dtype);
	RTME(dtype, 0);
