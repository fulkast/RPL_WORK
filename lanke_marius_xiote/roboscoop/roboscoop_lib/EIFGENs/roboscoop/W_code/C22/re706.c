...
extern EIF_TYPED_VALUE F706_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F706_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 705, Current, 0, 0, 3973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(705, Current, 3973);
	RTIV(Current, RTAL);
	RTHOOK(1);
