...
extern void F715_7495(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F715_7496(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F715_7497(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F715_7498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F715_7499(EIF_REFERENCE);
extern EIF_TYPED_VALUE F715_7500(EIF_REFERENCE);
extern EIF_TYPED_VALUE F715_7501(EIF_REFERENCE);
extern EIF_TYPED_VALUE F715_7502(EIF_REFERENCE);
extern EIF_TYPED_VALUE F715_7503(EIF_REFERENCE);
extern EIF_TYPED_VALUE F715_7504(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F715_7505(EIF_REFERENCE);
extern EIF_TYPED_VALUE F715_7506(EIF_REFERENCE);
extern void F715_7507(EIF_REFERENCE);
extern void F715_7508(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F715_7509(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F715_7510(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F715_7511(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F715_7512(EIF_REFERENCE);
...
void F715_7495 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
...
#define arg4 arg4x.it_n4
	...
	RTEAA(l_feature_name, 714, Current, 0, 4, 12606);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12606);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F715_7496 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 714, Current, 1, 3, 12607);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12607);
	RTIV(Current, RTAL);
...
void F715_7497 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 714, Current, 2, 4, 12608);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12608);
	RTIV(Current, RTAL);
	RTHOOK(1);
	if ((EIF_BOOLEAN)(arg2 == ((EIF_INTEGER_32) 0L))) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F715_7498 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT8;
	r.it_i1 = *(EIF_INTEGER_8 *)(Current + RTWA(5357,Dtype(Current)));
	return r;
}


/* {RT_DBG_LOCAL_RECORD}.callstack_depth */
EIF_TYPED_VALUE F715_7499 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F715_7500 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT32;
...
EIF_TYPED_VALUE F715_7501 (EIF_REFERENCE Current)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 714, Current, 0, 0, 12612);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12612);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F715_7502 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 714, Current, 0, 0, 12595);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(714, Current, 12595);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F715_7503 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F715_7504 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 714, Current, 1, 1, 12597);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12597);
	RTCC(arg1, 714, l_feature_name, 1, eif_new_type(303, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if (tb2) {
		ti1_1 = *(EIF_INTEGER_8 *)(Current + RTWA(5357, dtype));
		ti1_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5357, "value", loc1))(loc1)).it_i1);
...
EIF_TYPED_VALUE F715_7505 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 714, Current, 0, 0, 12598);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12598);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F715_7506 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 714, Current, 1, 0, 12599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12599);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0x0C000000, 0, 0); /* loc1 */
	loc1 = *(EIF_INTEGER_8 *)(Current + RTWA(5357, dtype));
	RTHOOK(2);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5343, dtype));
	switch (ti4_1) {
		case 1L:
		...
		default:
			...
			if (EIF_TRUE) {
				...
				RTDBGAL(Current, 0, 0xF800011F, 0,0); /* Result */
				ui1_1 = loc1;
				Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5361, dtype))(Current, ui1_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			} else {
				RTHOOK(12);
				RTDBGAL(Current, 0, 0xF800011F, 0,0); /* Result */
				tr1 = RTLN(eif_new_type(287, 0x01).id);
...
void F715_7507 (EIF_REFERENCE Current)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 714, Current, 1, 0, 12600);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12600);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype));
	ui4_1 = ti4_1;
	...
	tr1 = RTCCL(tr2);
	RTOB(*(EIF_INTEGER_8 *), RTWCT(5357, dtype, Dftype(Current)), tr1, loc1, tb1);
	if (tb1) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 5357, 0x0C000000, 0); /* value */
		*(EIF_INTEGER_8 *)(Current + RTWA(5357, dtype)) = (EIF_INTEGER_8) loc1;
	} else {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 5357, 0x0C000000, 0); /* value */
		ti1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5362, dtype))(Current)).it_i1);
		*(EIF_INTEGER_8 *)(Current + RTWA(5357, dtype)) = (EIF_INTEGER_8) ti1_1;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F715_7508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 714, Current, 0, 1, 12601);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12601);
	RTCC(arg1, 714, l_feature_name, 1, eif_new_type(303, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F715_7509 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 714, Current, 0, 1, 12602);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12602);
	RTCC(arg1, 714, l_feature_name, 1, eif_new_type(303, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F715_7510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 714, Current, 1, 1, 12603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12603);
	RTCC(arg1, 714, l_feature_name, 1, eif_new_type(303, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if (EIF_TEST(loc1)) {
		...
		tu4_1 = *(EIF_NATURAL_32 *)(Current + RTWA(5359, dtype));
		uu4_1 = tu4_1;
		ti1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5357, "value", loc1))(loc1)).it_i1);
		ui1_1 = ti1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5356, dtype))(Current, ui4_1x, ui4_2x, uu4_1x, ui1_1x);
	} else {
		if (RTAL & CK_CHECK) {
			RTHOOK(4);
...
EIF_TYPED_VALUE F715_7511 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 714, Current, 0, 1, 12604);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(714, Current, 12604);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F715_7512 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 714, Current, 0, 0, 12605);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(714, Current, 12605);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
