...
extern EIF_TYPED_VALUE F539_3979(EIF_REFERENCE);
extern void F539_3980(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F539_3981(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F539_3982(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F539_3983(EIF_REFERENCE);
extern EIF_TYPED_VALUE F539_3984(EIF_REFERENCE);
extern EIF_TYPED_VALUE F539_3985(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F539_3979 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 538, Current, 1, 0, 5492);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 5492);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.force */
void F539_3980 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 538, Current, 0, 1, 5493);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 5493);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCT("item_inserted", EX_POST);
		ub1 = arg1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2139, dtype))(Current, ub1x)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
/* {LINKED_STACK}.extend */
void F539_3981 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 538, Current, 0, 1, 5494);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 5494);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {LINKED_STACK}.put */
void F539_3982 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 538, Current, 0, 1, 5495);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 5495);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {LINKED_STACK}.remove */
void F539_3983 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 538, Current, 0, 0, 5496);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 5496);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F539_3984 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 538, Current, 1, 0, 5497);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 5497);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(5);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3033, dtype))(Current)).it_b);
		ub1 = tb2;
...
EIF_TYPED_VALUE F539_3985 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 538, Current, 3, 1, 5498);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 5498);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		RTHOOK(7);
		RTDBGAL(Current, 3, 0xF800021B, 0, 0); /* loc3 */
		...
		for (;;) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3033, dtype))(Current)).it_b);
			ub1 = tb2;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2967, "put_right", loc3))(loc3, ub1x);
			RTHOOK(12);
