...
extern EIF_TYPED_VALUE F548_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F548_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 547, Current, 0, 0, 3969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(547, Current, 3969);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000220, 0,0); /* Result */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,544,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
