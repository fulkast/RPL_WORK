...
extern EIF_TYPED_VALUE F812_2540(EIF_REFERENCE);
extern EIF_TYPED_VALUE F812_2541(EIF_REFERENCE);
extern EIF_TYPED_VALUE F812_2542(EIF_REFERENCE);
extern void F812_2543(EIF_REFERENCE);
extern void F812_2544(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F812_2540 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 811, Current, 0, 0, 2481);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(811, Current, 2481);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F812_2541 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F812_2542 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 811, Current, 0, 0, 2478);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(811, Current, 2478);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F812_2543 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 811, Current, 0, 0, 2479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(811, Current, 2479);
	RTIV(Current, RTAL);
...
void F812_2544 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 811, Current, 0, 0, 2480);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(811, Current, 2480);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
