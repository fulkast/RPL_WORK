...
extern EIF_TYPED_VALUE F823_3737(EIF_REFERENCE);
extern EIF_TYPED_VALUE F823_3738(EIF_REFERENCE);
extern void F823_3744(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F823_3747(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F823_3748(EIF_REFERENCE);
extern EIF_TYPED_VALUE F823_3749(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F823_3737 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 822, Current, 0, 0, 5209);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(822, Current, 5209);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F823_3738 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 822, Current, 0, 0, 5210);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(822, Current, 5210);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F823_3744 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 822, Current, 0, 1, 5211);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(822, Current, 5211);
	RTIV(Current, RTAL);
...
void F823_3747 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 822, Current, 0, 1, 5212);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(822, Current, 5212);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F823_3748 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 822, Current, 0, 0, 5213);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(822, Current, 5213);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F823_3749 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 822, Current, 2, 1, 5214);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(822, Current, 5214);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ui2_1 = ti2_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2152, "extend", Result))(Result, ui2_1x);
		RTHOOK(9);
