...
extern EIF_TYPED_VALUE F474_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F474_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 473, Current, 0, 0, 3967);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(473, Current, 3967);
	RTIV(Current, RTAL);
	RTHOOK(1);
