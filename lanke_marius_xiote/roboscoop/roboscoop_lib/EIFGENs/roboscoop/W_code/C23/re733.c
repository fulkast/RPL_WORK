...
extern EIF_TYPED_VALUE F733_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F733_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 732, Current, 0, 0, 3974);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(732, Current, 3974);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80002DD, 0,0); /* Result */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,733,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
