...
extern EIF_TYPED_VALUE F682_2628(EIF_REFERENCE);
extern void F682_7571(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F682_2628 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 2652);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 2652);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F682_7571 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 681, Current, 0, 7570);
	RTSA(dtype);
	RTME(dtype, 0);
