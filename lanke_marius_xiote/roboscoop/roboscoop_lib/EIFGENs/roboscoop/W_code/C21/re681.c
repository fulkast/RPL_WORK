...
extern EIF_TYPED_VALUE F681_2631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F681_2632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F681_2633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F681_2634(EIF_REFERENCE);
extern void F681_2635(EIF_REFERENCE);
extern void F681_7573(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F681_2631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F681_2632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F681_2633 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 680, Current, 0, 0, 2721);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(680, Current, 2721);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F681_2634 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 680, Current, 0, 0, 2722);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(680, Current, 2722);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F681_2635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 680, Current, 0, 0, 2717);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(680, Current, 2717);
	RTIV(Current, RTAL);
...
void F681_7573 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 680, Current, 0, 7572);
	RTSA(dtype);
	RTME(dtype, 0);
