...
extern EIF_TYPED_VALUE F678_2540(EIF_REFERENCE);
extern EIF_TYPED_VALUE F678_2541(EIF_REFERENCE);
extern EIF_TYPED_VALUE F678_2542(EIF_REFERENCE);
extern void F678_2543(EIF_REFERENCE);
extern void F678_2544(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F678_2540 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 677, Current, 0, 0, 2461);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(677, Current, 2461);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F678_2541 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F678_2542 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 677, Current, 0, 0, 2458);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(677, Current, 2458);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F678_2543 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 677, Current, 0, 0, 2459);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(677, Current, 2459);
	RTIV(Current, RTAL);
...
void F678_2544 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 677, Current, 0, 0, 2460);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(677, Current, 2460);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
