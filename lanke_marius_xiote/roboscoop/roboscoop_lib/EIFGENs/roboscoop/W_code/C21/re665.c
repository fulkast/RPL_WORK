...
extern EIF_TYPED_VALUE F665_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F665_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 664, Current, 0, 0, 3972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(664, Current, 3972);
	RTIV(Current, RTAL);
	RTHOOK(1);
