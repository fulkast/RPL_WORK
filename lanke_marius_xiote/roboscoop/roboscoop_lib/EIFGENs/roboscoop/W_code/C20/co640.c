...
extern EIF_TYPED_VALUE F640_2540(EIF_REFERENCE);
extern EIF_TYPED_VALUE F640_2541(EIF_REFERENCE);
extern EIF_TYPED_VALUE F640_2542(EIF_REFERENCE);
extern void F640_2543(EIF_REFERENCE);
extern void F640_2544(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F640_2540 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 639, Current, 0, 0, 2456);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(639, Current, 2456);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F640_2541 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F640_2542 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 639, Current, 0, 0, 2453);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(639, Current, 2453);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F640_2543 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 639, Current, 0, 0, 2454);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(639, Current, 2454);
	RTIV(Current, RTAL);
...
void F640_2544 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 639, Current, 0, 0, 2455);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(639, Current, 2455);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
