...
extern EIF_TYPED_VALUE F628_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F628_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 627, Current, 0, 0, 3971);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(627, Current, 3971);
	RTIV(Current, RTAL);
	RTHOOK(1);
