...
extern EIF_TYPED_VALUE F600_2628(EIF_REFERENCE);
extern void F600_7571(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F600_2628 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 599, Current, 0, 0, 2648);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(599, Current, 2648);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F600_7571 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 599, Current, 0, 7570);
	RTSA(dtype);
	RTME(dtype, 0);
