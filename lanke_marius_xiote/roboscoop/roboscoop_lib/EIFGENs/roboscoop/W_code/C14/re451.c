...
extern EIF_TYPED_VALUE F451_2631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F451_2632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F451_2633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F451_2634(EIF_REFERENCE);
extern void F451_2635(EIF_REFERENCE);
extern void F451_7573(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F451_2631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F451_2632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F451_2633 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 450, Current, 0, 0, 2685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(450, Current, 2685);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F451_2634 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 450, Current, 0, 0, 2686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(450, Current, 2686);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F451_2635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 450, Current, 0, 0, 2681);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(450, Current, 2681);
	RTIV(Current, RTAL);
...
void F451_7573 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 450, Current, 0, 7572);
	RTSA(dtype);
	RTME(dtype, 0);
