...
extern EIF_TYPED_VALUE F459_3737(EIF_REFERENCE);
extern EIF_TYPED_VALUE F459_3738(EIF_REFERENCE);
extern void F459_3744(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F459_3747(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F459_3748(EIF_REFERENCE);
extern EIF_TYPED_VALUE F459_3749(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F459_3737 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 5155);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(458, Current, 5155);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F459_3738 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 5156);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(458, Current, 5156);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F459_3744 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 458, Current, 0, 1, 5157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 5157);
	RTIV(Current, RTAL);
...
void F459_3747 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 458, Current, 0, 1, 5158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 5158);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F459_3748 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 5159);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 5159);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F459_3749 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 458, Current, 2, 1, 5160);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 5160);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
