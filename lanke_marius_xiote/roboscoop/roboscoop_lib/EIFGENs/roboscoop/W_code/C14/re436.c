...
extern EIF_TYPED_VALUE F436_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F436_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 435, Current, 0, 0, 3966);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 3966);
	RTIV(Current, RTAL);
	RTHOOK(1);
