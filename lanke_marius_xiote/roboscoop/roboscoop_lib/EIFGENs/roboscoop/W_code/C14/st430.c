...
extern void F430_2624(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F430_2625(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F430_2624 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 429, Current, 0, 1, 2629);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(429, Current, 2629);
	RTCC(arg1, 429, l_feature_name, 1, RTWCT(2188, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F430_2625 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 429, Current, 1, 1, 2630);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(429, Current, 2630);
	{
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(6);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2219, "item", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
