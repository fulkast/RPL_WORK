...
extern EIF_TYPED_VALUE F504_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F504_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 503, Current, 0, 0, 3968);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(503, Current, 3968);
	RTIV(Current, RTAL);
	RTHOOK(1);
