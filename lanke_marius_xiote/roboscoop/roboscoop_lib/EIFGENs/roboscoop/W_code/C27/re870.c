...
extern EIF_TYPED_VALUE F870_2631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F870_2632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F870_2633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F870_2634(EIF_REFERENCE);
extern void F870_2635(EIF_REFERENCE);
extern void F870_7573(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F870_2631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F870_2632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F870_2633 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 869, Current, 0, 0, 2751);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(869, Current, 2751);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F870_2634 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 869, Current, 0, 0, 2752);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(869, Current, 2752);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F870_2635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 869, Current, 0, 0, 2747);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(869, Current, 2747);
	RTIV(Current, RTAL);
...
void F870_7573 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 869, Current, 0, 7572);
	RTSA(dtype);
	RTME(dtype, 0);
