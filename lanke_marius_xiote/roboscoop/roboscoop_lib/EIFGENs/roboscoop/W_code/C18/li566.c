...
extern EIF_TYPED_VALUE F566_3752(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F566_3753(EIF_REFERENCE);
extern EIF_TYPED_VALUE F566_3754(EIF_REFERENCE);
extern void F566_7594(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F566_3752 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 565, Current, 2, 1, 5251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(565, Current, 5251);
...
/* {LIST}.after */
EIF_TYPED_VALUE F566_3753 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 565, Current, 0, 0, 5252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(565, Current, 5252);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F566_3754 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 565, Current, 0, 0, 5253);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(565, Current, 5253);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F566_7594 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 565, Current, 0, 7593);
	RTSA(dtype);
	RTME(dtype, 0);
