...
extern EIF_TYPED_VALUE F568_2615(EIF_REFERENCE);
extern EIF_TYPED_VALUE F568_2616(EIF_REFERENCE);
extern void F568_2617(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F568_7570(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F568_2615 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 567, Current, 0, 0, 2624);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(567, Current, 2624);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F568_2616 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 567, Current, 0, 0, 2625);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(567, Current, 2625);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2140, Dtype(Current)))(Current)).it_b);
...
/* {DISPENSER}.append */
void F568_2617 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 567, Current, 0, 1, 2626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(567, Current, 2626);
	{
		...
		RTCC(arg1, 567, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
void F568_7570 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 567, Current, 0, 7569);
	RTSA(dtype);
	RTME(dtype, 0);
