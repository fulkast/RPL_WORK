...
extern EIF_TYPED_VALUE F592_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F592_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 591, Current, 0, 0, 3970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(591, Current, 3970);
	RTIV(Current, RTAL);
	RTHOOK(1);
